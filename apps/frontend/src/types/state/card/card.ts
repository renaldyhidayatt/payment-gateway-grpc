...
export interface CardStore{
    ...
    findAllCards: (search: string, page: number, pageSize: number) => Promise<void>;
    findByIdCard: (id: number) => Promise<void>;
    findByUser: (userId: number, search: string, page: number, pageSize: number) => Promise<void>;
    findByCardNumber: (cardNumber: string) => Promise<void>;
    findByActiveCard: (search: string, page: number, pageSize: number) => Promise<void>;
    findByTrashedCard: (search: string, page: number, pageSize: number) => Promise<void>;
    
    createCard: (req: CreateCard) => Promise<void>;
    updateCard: (id: number,req: UpdateCard) => Promise<void>;
    trashedCard: (id: number) => Promise<void>;
    restoreCard: (id: number) => Promise<void>;
    deletePermanentCard: (id: number) => Promise<void>;
