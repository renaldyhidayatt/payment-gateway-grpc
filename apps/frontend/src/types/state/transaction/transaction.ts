...
export interface TransactionStore{
    ...
    findAllTransactions: (search: string, page: number, pageSize: number) => Promise<void>;
    ...
    findByActiveTransaction: (search: string, page: number, pageSize: number) => Promise<void>;
    findByTrashedTransaction: (search: string, page: number, pageSize: number) => Promise<void>;
    createTransaction: (req: CreateTransaction) => Promise<void>;
    updateTransaction: (id: number, req: UpdateTransaction) => Promise<void>;
    restoreTransaction: (id: number) => Promise<void>;
    trashedTransaction: (id: number) => Promise<void>;
    deleteTransactionPermanent: (id: number) => Promise<void>;
}