...
export interface SaldoStore {
    ...
    findAllSaldos: (search: string, page: number, pageSize: number) => Promise<void>;
    findByIdSaldo: (id: number) => Promise<void>;
    findByActiveSaldo: (search: string, page: number, pageSize: number) => Promise<void>;
    findByTrashedSaldo: (search: string, page: number, pageSize: number) => Promise<void>;
    findByCardNumberSaldo: (cardNumber: string) => Promise<void>;
    createSaldo: (req: CreateSaldo) => Promise<void>;
    updateSaldo: (id: number, req: UpdateSaldo) => Promise<void>;
    restoreSaldo: (id: number) => Promise<void>;
    trashedSaldo: (id: number) => Promise<void>;
    deleteSaldoPermanent: (id: number) => Promise<void>;
