...
export interface TransferStore{
    ...
    findAllTransfers: (search: string, page: number, pageSize: number) => Promise<void>;
    ...
    findByActiveTransfer: (search: string, page: number, pageSize: number) => Promise<void>;
    findByTrashedTransfer: (search: string, page: number, pageSize: number) => Promise<void>;
    createTransfer: (req: any) => Promise<void>;
    updateTransfer: (id: number, req: any) => Promise<void>;
    restoreTransfer: (id: number) => Promise<void>;
    trashedTransfer: (id: number) => Promise<void>;
    deleteTransferPermanent: (id: number) => Promise<void>;
}