...
const useCardStore = create<CardStore>((set, get) => ({
    ...
    setErrorGetCardByUser: (value: string | null) => set({ errorGetCardByUser: value }),
    setErrorGetActiveCards: (value: string | null) => set({ errorGetActiveCards: value }),
    setErrorGetTrashedCards: (value: string | null) => set({ errorGetTrashedCards: value }),
    setErrorGetCardByCardNumber: (value: string | null) => set({ errorGetCardByCardNumber: value }),
    ...
    setErrorTrashedCard: (value: string | null) => set({ errorTrashedCard: value }),
    setErrorRestoreCard: (value: string | null) => set({ errorRestoreCard: value }),
    ...
    setLoadingGetCardByUser: (value: boolean) => set({ loadingGetCardByUser: value }),
    setLoadingGetActiveCards: (value: boolean) => set({ loadingGetActiveCards: value }),
    setLoadingGetTrashedCards: (value: boolean) => set({ loadingGetTrashedCards: value }),
    setLoadingGetCardByCardNumber: (value: boolean) => set({ loadingGetCardByCardNumber: value }),
    ...
    findByUser: async (id: number) => {
        ...
        try {
            ...
            set({ cards: response.data, loadingGetCardByUser: false, errorGetCardByUser: null });
    ...
    findByCardNumber: async (cardNumber: string) => {
        ...
        try {
            ...
            set({ card: response.data, loadingGetCardByCardNumber: false, errorGetCardByCardNumber: null });
        } catch (err) {
            handleApiError(
                err,
    ...
    createCard: async (req: CreateCard) => {
        ...
        try {
            ...
            set({ card: response.data, loadingCreateCard: false, errorCreateCard: null });
            return response.data;
        } catch (err) {
            handleApiError(
                err,
    ...
    updateCard: async (id: number, req: UpdateCard) => {
        ...
        try {
            ...
            set({ card: response.data, loadingUpdateCard: false, errorUpdateCard: null });
            return response.data;
        } catch (err) {
            handleApiError(
                err,
